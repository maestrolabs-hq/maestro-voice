...
- **Requirement:** Dependencies MUST be pinned with ecosystem lockfiles where supported, licensed under the bound project policy, and audited using the [quality profiles](https://github.com/maestrolabs-hq/maestro-manifests/blob/main/manifests/profiles/README.md) and [shared baseline](https://github.com/maestrolabs-hq/maestro-manifests/blob/main/manifests/profiles/base/quality-baseline.yaml). Unresolved license or vulnerability decisions MUST NOT be treated as clearance; apply SCH-005 and SCH-011.
